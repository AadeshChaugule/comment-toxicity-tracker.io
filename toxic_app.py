...
def predict():
    ...
    out_tox = round(pred_tox[0]*100, 2)
    out_sev = round(pred_sev[0]*100, 2)
    out_obs = round(pred_obs[0]*100, 2)
    out_ins = round(pred_ins[0]*100, 2)
    out_thr = round(pred_thr[0]*100, 2)
    out_ide = round(pred_ide[0]*100, 2)
